...
function getParserForUrl (url) {
  if (url.startsWith('https://www.morningstar.fi/fi/etf/snapshot/snapshot.aspx?id=')) {
    return morningStarEtfOrFundParser
  } else if (url.startsWith('https://www.morningstar.fi/fi/funds/snapshot/snapshot.aspx?id=')) {
    return morningStarEtfOrFundParser
  } else if (url.startsWith('https://tools.morningstar.fi/fi/stockreport/default.aspx?SecurityToken=')) {
    return morningStarStockParser
  } else if (url.startsWith('https://www.seligson.fi/graafit/') && url.endsWith('.csv')) {
